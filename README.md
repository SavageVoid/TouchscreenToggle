...
Designed for reliability, safety, and zero-configuration usage.
 ...
 Features
    ...
    -  **Visual Feedback** - Desktop notifications & sound
    -  **Action History** - Track last 50 toggle events
    -  **Auto-Enable Safety** - On sleep, lock, shutdown, exit
    -  **Settings GUI** - No config editing needed
    -  **Lightweight** - ~2MB RAM usage
